...
namespace IdentityPackage.Builders
{
  public class PasswordValidationBuilder
  {
    ...
    public PasswordValidationBuilder MustHaveSpecialCharacter(bool specialCharacter, string? message = null)
    {
    ...
    public PasswordValidationBuilder MustHaveLowerCaseCharacter(bool lowerCaseCharacter, string? message = null)
    {
    ...
    public PasswordValidationBuilder MustHaveUpperCaseCharacter(bool upperCaseCharacter, string? message = null)
    {
